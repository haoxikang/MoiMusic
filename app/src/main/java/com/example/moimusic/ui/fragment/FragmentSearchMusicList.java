...
import com.example.moimusic.reject.components.DaggerFragmentSearchMusicListComponent;
 ...
 */
public class FragmentSearchMusicList  extends BaseFragment implements FragmentSearchMusicListView{
    @Inject
    FragmentSearchMusicListPresenter presenter;
    private RecyclerView recyclerView;
    private SwipeRefreshLayout swipeRefreshLayout;
    private String searchStr;
    public final static String EXTRA_SEARCH_STRING= "com.moimusic.fragment.searchmusiclist";
    @Override
    ...
    protected void setupFragmentComponent(AppComponent appComponent) {
        DaggerFragmentSearchMusicListComponent.builder()
                .appComponent(appComponent)
                .fragmentSearchMusicListModule(new FragmentSearchMusicListModule(this))
                .build()
                .inject(this);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_search_music_list, container, false);
    ...
    private void initview(View v){
        ...
        recyclerView.setAdapter(new SearchMusicListAdapter("",new ArrayList<>()));
    ...
    @Override
    public void showList(SearchMusicListAdapter adapter) {
    ...
    public static   FragmentSearchMusicList newInstance(String searchStr){
        Bundle args = new Bundle();
        args.putString(EXTRA_SEARCH_STRING,searchStr);
        FragmentSearchMusicList fragmentSearchMusicList = new FragmentSearchMusicList();
        fragmentSearchMusicList.setArguments(args);
